    ...
    <section className="mt-5 rounded-2xl border border-border bg-card p-5 shadow-sm sm:p-6" data-hero-exclusive-equipment="true">
      ...
      {exclusiveEquipment.released && detail ? (
        <div className="mt-5 grid gap-4 sm:grid-cols-[128px_minmax(0,1fr)] sm:items-start">
          <div className="min-w-0" data-hero-exclusive-equipment-visual="true">
            ...
            <h3
              className="mt-2 text-center text-sm font-bold leading-5 text-foreground"
              data-hero-exclusive-equipment-name="true"
            >
              {detail.identity.nameKr ?? detail.identity.nameCn}
            </h3>
          </div>

          <div className="min-w-0 rounded-xl border border-border bg-muted/20 p-4" data-hero-exclusive-equipment-copy="true">
