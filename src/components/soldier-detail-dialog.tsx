  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="flex max-h-[calc(100dvh-1rem)] w-full max-w-6xl flex-col sm:max-h-[90vh]"
      >
        <button
          type="button"
          aria-label="상세 창 닫기"
          ...
          onClick={onClose}
          className="mb-2 flex h-11 w-11 shrink-0 self-end items-center justify-center rounded-full border border-border bg-background text-foreground shadow-md transition hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
