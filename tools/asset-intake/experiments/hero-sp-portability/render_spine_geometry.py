...
def main():
    ...
    ap.add_argument('--hero-id', type=int, required=True)
    ...
    result = {
        'schemaVersion': 1,
        'stage': 'asset-portability',
        'substage': 'hero-sp-cleanroom-render',
        'status': 'PASS_CLEANROOM_SPINE_CHAR_IDLE_RENDER',
        'heroId': args.hero_id,
        'guardrails': {
        ...
        'decision': 'PORTABILITY_RENDER_READY',
    }
