...
assert(overrideById.size === 16, `expected 16 review overrides, got ${overrideById.size}`);
...
assert(passCount === 125, `PASS count must be 125, got ${passCount}`);
assert(reviewCount === 60, `REVIEW count must be 60, got ${reviewCount}`);
