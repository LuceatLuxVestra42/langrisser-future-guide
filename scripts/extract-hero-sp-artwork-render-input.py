...
EVIDENCE=pathlib.Path('data/evidence/hero-sp-artwork-source-census.v1.json')
...
out=pathlib.Path(f'.probe-out/sp-render/{HERO_ID}'); rawdir=out/'raw'; rawdir.mkdir(parents=True,exist_ok=True)
